...
const ONBOARDING_NO_AUTH = {
  ...
  steps: [
    "1. Sign up at https://agenttodo.ai/signin?ref=agent-api",
    "2. Create an API key at https://agenttodo.ai/dashboard/agents",
  ...
  links: {
    ...
    api_info: "https://agenttodo.ai/api",
  },
  example:
...
const ONBOARDING_INVALID_KEY = {
  ...
  steps: [
    "1. Go to https://agenttodo.ai/dashboard/agents",
